    ...
    <div className="flex-1">
      ...
      <div className="p-8 max-w-[1100px] mx-auto">
        ...
        <div className="gap-8 mt-20 grid grid-cols-2">
          <a
            href=""
            className="bg-grey-700 rounded overflow-hidden flex items-stretch gap-6 hover:bg-grey-600 transition-colors"
          >
          ...
          >
            ...
            <div className="py-6 leading-relaxed">
              ...
              <p className="text-sm text-grey-200 mt-2">
                Wallpapers exclusivos do Inite Lab e personalize a sua máquina
              </p>
            </div>
            <div className="h-full p-6 flex items-center">
              <CaretRight size={24} />
